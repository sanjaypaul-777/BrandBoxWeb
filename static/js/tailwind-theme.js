...
tailwind.config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {"body-md": ["Inter","system-ui","sans-serif"],"body-lg": ["Inter","system-ui","sans-serif"],"label-caps": ["JetBrains Mono","ui-monospace","monospace"],"headline-lg": ["Plus Jakarta Sans","system-ui","sans-serif"],"headline-lg-mobile": ["Plus Jakarta Sans","system-ui","sans-serif"],"headline-md": ["Plus Jakarta Sans","system-ui","sans-serif"],"display-hero": ["Plus Jakarta Sans","system-ui","sans-serif"],"display-hero-mobile": ["Plus Jakarta Sans","system-ui","sans-serif"],
      },
      fontSize: {"body-md": ["16px", { lineHeight:"1.5", fontWeight:"400" }],"body-lg": ["18px", { lineHeight:"1.6", fontWeight:"400" }],"label-caps": ["12px",
        ...
        ],"headline-lg-mobile": ["32px", { lineHeight:"1.2", fontWeight:"700" }],"display-hero": ["72px",
          { lineHeight:"1.1", letterSpacing:"-2.88px", fontWeight:"800" },
        ],"display-hero-mobile": ["48px",
          { lineHeight:"1.1", letterSpacing:"-0.96px", fontWeight:"800" },
